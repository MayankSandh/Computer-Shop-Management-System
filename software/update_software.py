# -*- coding: utf-8 -*-
"""
Created on Sun Dec 26 09:21:43 2021
...
def update_software():
    ...
    while True:
        ...
        file_names=["antivirus.csv","cloud storage.csv","games.csv"]      #file_names are used to attach files with source code
        files=["Antivirus","Cloud Storage","Games"]                           #files are the names which will be shown in output
        ...
        for n in range(len(file_names)):                                                  #n=0,1,2,3,4,5... (number of files-1)
            if choice==(n+1):
                while True:
                    ...
                    if choice1==1:   
                        print("\033c")
                        with open('software/{}'.format(file_names[n]),"a",newline="")as file:
                    ...
                    if choice1==2:
                        while True:
                            infile=open('software/{}'.format(file_names[n]),"r")
                                            ...
                                            if choice3==no+1:
                                                while True:  
                                                    ...
                                                    if choice4==3:
                                                        ...
                                                        ofile=open('software/{}'.format(file_names[n]),"w",newline="")
